...
```javascript
var data = { "from_date": "2026-04-01",
                     "to_date": "2027-03-31",
                      "page_size": 1
                      }

fyers.get_charges_history(data).then((response) => {
    console.log(response)
}).catch((error) => {
    console.log(error)
})
...
fyers.get_realised_profit_history(data).then((response) => {
    console.log(response)
}).catch((error) => {
    console.log(error)
})
...
fyers.get_tax_pnl_history(data).then((response) => {
    console.log(response)
}).catch((error) => {
    console.log(error)
})
...
fyers.get_ledger_history(data).then((response) => {
    console.log(response)
}).catch((error) => {
    console.log(error)
})
